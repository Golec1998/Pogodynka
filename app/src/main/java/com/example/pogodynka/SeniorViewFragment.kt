...
class SeniorViewFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_senior_view, container, false)
        ...
        val changeViewButton = view.findViewById<Button>(R.id.switchToJunior)
        ...
        changeViewButton.setOnClickListener { view.findNavController().navigate(R.id.action_seniorViewFragment_to_mainViewFragment) }
    ...
    private fun updateWeather(c : String, view : View) {
        ...
        view.findViewById<TextView>(R.id.sunrise).setText("Wschód: " + sunrise)
        view.findViewById<TextView>(R.id.sunset).setText("Zachód: " + sunset)

        // Wiatr
        view.findViewById<TextView>(R.id.wind).setText("Wiatr: " + appViewModel.forecast.wind.speed.toString() + " m/s " + getDirection(appViewModel.forecast.wind.deg))

        // Wilgotność i ciśnienie
        view.findViewById<TextView>(R.id.humidity).setText("Wilgotność: " + appViewModel.forecast.main.humidity.toString() + "%")
        view.findViewById<TextView>(R.id.pressure).setText("Ciśnienie: " + appViewModel.forecast.main.pressure.toString() + " hPa")

        // Zachmurzenie i widoczność
        view.findViewById<TextView>(R.id.visibility).setText("Widoczność: " + getVisibility(appViewModel.forecast.visibility))
        view.findViewById<TextView>(R.id.clouds).setText("Zachmurzenie: " + appViewModel.forecast.clouds.all.toString() + "%")
    }
